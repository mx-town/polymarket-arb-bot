          ...
          return (
            ...
            >
              ...
              <div style={{
                ...
                <div>
                  <div style={{ color: 'var(--text-muted)', marginBottom: '0.125rem' }}>Combined Ask</div>
                  <div style={{ fontFamily: 'var(--font-mono)', color: 'var(--text-primary)' }}>
                    ${market.combined_ask.toFixed(4)}
                  </div>
                </div>
                <div>
                  <div style={{ color: 'var(--text-muted)', marginBottom: '0.125rem' }}>Combined Bid</div>
                  <div style={{ fontFamily: 'var(--font-mono)', color: 'var(--text-primary)' }}>
                ...
                <div>
                  <div style={{ color: 'var(--text-muted)', marginBottom: '0.125rem' }}>Profit If &lt;$1</div>
                  <div style={{
                    fontFamily: 'var(--font-mono)',
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ color: 'var(--accent-green)', fontWeight: 500, marginBottom: '0.125rem' }}>
                    UP
                  </div>
                ...
                <div style={{
                  ...
                  <div style={{ color: 'var(--accent-red)', fontWeight: 500, marginBottom: '0.125rem' }}>
                    DOWN
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <span style={{ color: 'var(--text-muted)' }}>Ask</span>
