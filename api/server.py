...
from api.controllers.pipeline_controller import PipelineController
from api.research_state import ResearchStateManager
from api.routes import config, control, metrics, research, trading
...
# Shutdown hook — kill any running subprocesses
@app.on_event("shutdown")
async def shutdown_event():
    pipeline_controller = PipelineController.get_instance()
    await pipeline_controller.shutdown()
